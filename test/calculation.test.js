...
test('calendar day reads Monday based daily slots', () => {
    const monday = new Date(2026, 7, 17, 12);
    assert.equal(c.calendarDayMinutes(monday, '[["10:00",90,0],["00:00",0,0],["00:00",0,0],["00:00",0,0],["00:00",0,0],["00:00",0,0],["00:00",0,0]]'), 90);
});
