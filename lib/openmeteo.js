...
function buildOpenMeteoUrl(latitude, longitude) {
    const params = new URLSearchParams({
        ...
        hourly: 'temperature_2m,soil_moisture_0_to_1cm,shortwave_radiation,precipitation,et0_fao_evapotranspiration',
        past_days: '30',
        forecast_days: '1',
        timezone: 'auto'
    });
...
function parseOpenMeteo(data) {
    ...
    return {
        ...
        precipitationHistory: Array.isArray(data?.hourly?.precipitation) ? data.hourly.precipitation : [],
        et0History: Array.isArray(data?.hourly?.et0_fao_evapotranspiration) ? data.hourly.et0_fao_evapotranspiration : []
    };
}
