...
function accumulateGrowth(previousMm, dailyGrowthSamples, elapsedDays) {
    ...
    return round(Math.max(0, Number(previousMm) || 0) + averageDaily * Math.min(7, Math.max(0, Number(elapsedDays) || 0)));
}
...
module.exports = { SOILS, temperatureFactor, simulatePatch, aggregateZones, accumulateGrowth, sequenceFromWeights, legacySoil };
