...
- Getrennte Schalter: Regensperre und Wetter-Wachstumsanpassung können unabhängig aktiviert werden. Bei abgeschalteter Regensperre erfolgt keine wetterbedingte `-100 %`-Sperre. Bei abgeschalteter Wachstumsanpassung wirken Temperatur, Feuchte und Licht neutral; die konfigurierte Bodengüte je Zone bleibt aktiv.
