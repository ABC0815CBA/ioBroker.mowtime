...
- Wetteranpassungen: Können vollständig abgeschaltet werden. Dann gibt es keine Regensperre und Temperatur, Feuchte sowie Licht wirken neutral; die konfigurierte Bodengüte je Zone bleibt aktiv.
